...
- По 12 пункту возникает ошибка. Пробовал неоднократно. Блок для корректной работы робота обёрнут в контейнер try/except. В лог выводится кол-во строк в таблице
